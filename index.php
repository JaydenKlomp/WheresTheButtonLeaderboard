...
<body class="AllLevelsPage">
    <?php include("inc/header.php")?>

    <h1 class="pageTitle">All Levels</h1>
    <div class="mainContainer">
    <div class="categorySelector">
            <form action="POST">
                <label for="">Overall Performance</label>
                <input type="radio" name="category" id="Overall" onclick="location.href ='index.php'"<?php if(!isset($_GET['sort'])){echo 'checked';}?>>
