...
<body class="LevelOnePage">
    <?php include("inc/header.php")?>

    <h1 class="pageTitle">Level One</h1>

    <div class="mainContainer">
    <div class="categorySelector">
            <form action="POST">
                <label for="">Overall Performance</label>
                <input type="radio" name="category" id="Overall" onclick="location.href ='LevelOne.php'"<?php if(!isset($_GET['sort'])){echo 'checked';}?>>
        ...
        <?php displayPlayersLevelOneSort(); ?>
        </div>
    </div>
