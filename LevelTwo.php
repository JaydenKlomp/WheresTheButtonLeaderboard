...
<body class="LevelTwoPage">
    <?php include("inc/header.php")?>

    <h1 class="pageTitle">Level Two</h1>

    <div class="mainContainer">
    <div class="categorySelector">
            <form action="POST">
                <label for="">Overall Performance</label>
                <input type="radio" name="category" id="Overall" onclick="location.href ='LevelTwo.php'"<?php if(!isset($_GET['sort'])){echo 'checked';}?>>
        ...
        <?php displayPlayersLevelTwoSort(); ?>
        </div>
    </div>
